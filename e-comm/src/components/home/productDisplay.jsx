...
function ProductDisplay() {
  ...
  const products = [
    { img: chair1, name: 'Mesh Chair', price: '$100.09' },
    { img: chair2, name: 'Task Chair', price: '$130.59' },
    { img: chair3, name: 'Executive Chair', price: '$180.79' },
    { img: chair4, name: 'Drafting Chair', price: '$180.90' },
    { img: chair5, name: 'Ball Chair', price: '$185.92' },
    { img: chair6, name: 'Guest Chair', price: '$210.90' },
    { img: chair7, name: 'Tilt Chair', price: '$220.09' },
